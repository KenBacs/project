  ...
  <?php include '../includes/layouts/header.php';?>
    ...
    <div class="content container">
      <div class="col-md-4 col-md-offset-4">
        <h2 class="text-center"><span class="glyphicon glyphicon-wrench"></span> Manage shop</h2>
       ...
       <form id="" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="shop_desc" value="<?php echo $shop_description;?>">
                        </div> 
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <?php if($edit_state == false): ?>
                            <button  type="submit" name="submit" class="btn btn-primary btn-block">Create Shop</button> 
                          <?php else: ?>
                            <button  type="submit" name="update" class="btn btn-primary btn-block">Update Shop</button> 
                          <?php endif ?>
                ...
                <tr>
                 ...
                 <?php while ($row = mysqli_fetch_array($results)) { ?>
                  <tr>
                      ...
                      <td>
                      <a href="#" class="btn btn-info" role="button"><span class="glyphicon glyphicon-eye-open"></span> Visit my shop</a>
                      <a href="manage_shop.php?edit=<?php echo $row['shop_id']?>" class="btn btn-success" role="button"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                      <a href="manage_shop.php?del=<?php echo $row['shop_id']?>" class="btn btn-danger" role="button"><span class="glyphicon glyphicon-remove"></span> Delete</a>
                      </td>
